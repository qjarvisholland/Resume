%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TEMPLATE NEEDS TO BE COMPILED WITH XeLaTeX
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% TODO:
% 1. fix the gnarly commenting
% 2. normalize the header style for comments and between sections
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% CHANGELOG:
...
\runsubsection{PDXopen.tech}
\descript{| Creative Technologist }
\location{2020 - Jun 2021 | Portland OR (remote)}
\begin{tightemize}
...
\location{2020 - Dec 2021 | 111 SE MADISON, Portland OR}
\begin{tightemize}
...
\location{3+ years:}
\textbullet{Java}\textbullet{node}\textbullet{C/C++ }\textbullet{HTML}\textbullet{Max/msp}\\
\location{1+ years:}
\textbullet{python} \textbullet{Ruby} \textbullet{SVG}  \textbullet{D3.js}\textbullet{PD}\\
\location{0+ years:}
\textbullet{React} \textbullet{Pandas}  \textbullet{Go}\\


\subsection{Technology}
\textbullet{} Git/Github \textbullet{} Linux \textbullet{} Docker \textbullet{} VMware \textbullet{} Arduino \textbullet{} Raspi \textbullet{} Blender \textbullet{} Unity 3D\\
\textbullet{ Oculus Rift} \textbullet{ ESP Wifi Boards} \textbullet{ SDR}
\subsection{Arts}
\textbullet{ Graphic Facilitation} \textbullet{ Leadership}\\
\textbullet{ Speaking} \textbullet{ UX UI}
\textbullet{ Cultural Translation} \\
\textbullet{ Painting} \textbullet{ Typography} \textbullet{ Sound Design}
